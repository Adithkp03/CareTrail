# Development log (historical notes)

This document preserves earlier phase notes as history. Claims and test counts below may be outdated; see [the current README](../README.md) for the implemented product, deployment and limitations.
