...
def get_milestone_explanation(
    ...
    return milestone_explanation(db, m.key, m.title, current.get("prep_notes", m.prep_notes), journey.template_version, lang)
...
def get_milestone_explanation_audio(
    ...
    milestone_explanation(db, m.key, m.title, current.get("prep_notes", m.prep_notes), m.journey.template_version, lang)  # ensure cached
